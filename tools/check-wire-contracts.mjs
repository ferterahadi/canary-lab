...
const BASELINE = new Map([
  ...
  ['FeatureStageEvidence', {
    onlyServer: ['booted', 'coverageMapping', 'portInjectability', 'robustness'],
    onlyWeb: ['booted?', 'coverageMapping?', 'portInjectability?', 'robustness?'],
    reason: 'optionality-only: server always stamps all four; web tolerates pre-1.5 records that lack booted/portInjectability, pre-2.1 payloads that lack coverageMapping and pre-2.3 payloads that lack robustness',
  }],
])
