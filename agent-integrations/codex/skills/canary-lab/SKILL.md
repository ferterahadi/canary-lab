...
Robustness lab runs after Auto-repair and before Report — server-conducted, never
...
`links.robustnessJobId` names the job. It skips itself, with the reason on the
