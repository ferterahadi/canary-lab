...
export const LEDGER: CoverageLedger = {
  freshness: { revision: 'stale-inputs', checkedAt: '2026-09-17T00:00:00Z', state: 'stale', reasons: ['Source requirements changed.'], changedTests: [], latestRunFailed: false, proofNeedsRun: false,
