...
import { CoverageJobRunStore, type CoverageJobStore, type CoverageJobStoreEvent } from '../lib/coverage/jobs/store'
...
import type { CoverageJobManifest, CoverageJobIndexEntry, CoverageJobKind } from '../lib/coverage/jobs/types'
