...
- Evaluation export (run must be terminal, not necessarily passing): start_external_evaluation_export → submit_external_evaluation_export, then get/list/download_evaluation_export. If the run failed or was aborted and the user asks to export as-is, preserve that status in the report instead of trying to heal first.`
