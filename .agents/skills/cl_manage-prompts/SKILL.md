...
Every prompt canary sends to a spawned agent (Codex/codex) lives as a flat file
...
| `.Codex/skills/**/SKILL.md` | Codex skill definitions for contributors working on canary-lab itself, not agent-spawn prompts. |
