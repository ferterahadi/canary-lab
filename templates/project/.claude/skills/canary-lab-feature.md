---
name: Canary Lab Feature
description: Use when creating a Canary Lab feature scaffold or adding/modifying Playwright test cases in a canary-lab project. Teaches the deterministic CLI scaffold path, where specs/helpers belong, which fixture import to use, how to read service URLs, and how feature config/envsets affect tests. Triggered by "new canary-lab feature", "add a Playwright test", "create a test in canary-lab", "add a test case for X", "extend the X feature tests".
type: skill
---
