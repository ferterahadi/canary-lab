...
Diagnose from the error messages first. `Read` a slice file only if the error alone isn't enough. Grep distinctive literals in the repos listed. Fix the service/app code — never the test.
